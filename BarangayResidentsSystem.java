...
class BarangayColors {
    ...
    public static final Color SIDEBAR_GRAY = new Color(240, 242, 245);
    public static final Color TEXT_COLOR = new Color(46, 46, 46);
    public static final Color HEADER_BLUE = new Color(41, 82, 122);
    public static final Color TABLE_HEADER = new Color(240, 240, 245);
    public static final Color BORDER_COLOR = new Color(210, 210, 210);
    public static final Color BUTTON_BLACK = new Color(50, 50, 50);
    public static final Color BUTTON_HOVER = new Color(80, 80, 80);
    public static final Color BUTTON_ACTIVE = new Color(100, 100, 100);
    public static final Color DECEASED_COLOR = new Color(220, 220, 220);
    public static final Color ARCHIVE_COLOR = new Color(255, 240, 240);
    public static final Color LOGOUT_RED = new Color(220, 53, 69);
    public static final Color LOGOUT_HOVER = new Color(200, 35, 51);
}
...
class SecureFileHandler {
    ...
    private static final String ARCHIVE_FILE = "archive_records.dat";
...
public class BarangayResidentsSystem {
    ...
    private void initializeData() {
        ...
        archive = SecureFileHandler.loadArchive();
    }
    ...
    class MainDashboard extends JPanel {
        ...
        private List<ArchiveRecord> dashboardArchive;
    ...
    class ArchivePanel extends JPanel {
        ...
        private MainDashboard dashboard;
        private StyledTable archiveTable;
        ...
        private void restoreSelected() {
            ...
            if (selectedRecord != null) {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    ...
                    SecureFileHandler.saveArchive(panelArchive);
                    SecureFileHandler.logActivity(panelUser.getUsername(), 
                        "RESIDENT_RESTORED: " + String.format("%06d", residentID));
        ...
        private void permanentlyDelete() {
            ...
            if (selectedRecord != null) {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    ...
                    SecureFileHandler.saveArchive(panelArchive);
                    SecureFileHandler.logActivity(panelUser.getUsername(), 
                        "RESIDENT_PERMANENTLY_DELETED: " + String.format("%06d", residentID));
    ...
    class ManageResidentsModule extends JPanel {
        ...
        private void addResident() {
            ...
            if (dialog.showDialog()) {
                ...
                SecureFileHandler.incrementResidentId();
                SecureFileHandler.saveResidents(panelResidents);
                SecureFileHandler.logActivity(panelUser.getUsername(), 
                    "RESIDENT_ADDED: " + String.format("%06d", newResident.getResidentID()));
        ...
        private void editResident() {
            ...
            if (dialog.showDialog()) {
                SecureFileHandler.saveResidents(panelResidents);
                SecureFileHandler.logActivity(panelUser.getUsername(), 
                    "RESIDENT_UPDATED: " + String.format("%06d", selectedResident.getResidentID()));
        ...
        private void deleteResident() {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                SecureFileHandler.saveResidents(panelResidents);
                SecureFileHandler.logActivity(panelUser.getUsername(), 
                    "RESIDENT_DELETED: " + String.format("%06d", selectedResident.getResidentID()));
        ...
        private void markAsDeceased() {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                SecureFileHandler.saveArchive(panelArchive);
                SecureFileHandler.logActivity(panelUser.getUsername(), 
                    "RESIDENT_DECEASED: " + String.format("%06d", selectedResident.getResidentID()));
        ...
        private void markAsTransferred() {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                SecureFileHandler.saveArchive(panelArchive);
                SecureFileHandler.logActivity(panelUser.getUsername(), 
                    "RESIDENT_TRANSFERRED: " + String.format("%06d", selectedResident.getResidentID()));
